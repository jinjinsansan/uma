...
def test_niigata_4r():
    ...
    horses = [
        'タイショウロマン', 'エコログロス', 'カリータフェリス', 'オリオアルセーリオ',
        'ラッキーロジータ', 'ムーンストラック', 'ノブダブルホワイト', 'リースアンドリボン',
        'マイネルボス', 'エターナルシルバー', 'ヴィクトワールバゴ', 'セブンスプラネット',
        'ピコラ', 'ラインアルテミス', 'キロノヴァ', 'ムーンナイトローズ',
        'マーゴットフェスタ', 'ヴィルナタール'
    ]
    
    print("="*60)
    print("新潟4R - 3歳未勝利 展開予想テスト")
    print("="*60)
