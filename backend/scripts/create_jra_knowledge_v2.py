...
def create_jra_knowledge_quality():
    ...
    try:
        ...
        print(f"\n📅 対象期間: {target_year}年（1年分）")
        print("🏛️ 対象: JRA国内レースのみ（競馬場コード01-10）")
        print("-" * 60)
        ...
        WHERE se.kaisai_nen = '""" + target_year + """'
            -- 国内JRAレースのみ（01-10）
...
def main():
    ...
    # JRA版ナレッジファイル作成
    output_file, horse_count = create_jra_knowledge_quality()
