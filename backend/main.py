...
# from api.race_analysis_v2 import router as race_analysis_v2_router  # 一時的に無効化（メモリ問題）
...
# app.include_router(race_analysis_v2_router, tags=["Race Analysis V2"])  # 一時的に無効化（メモリ問題）
