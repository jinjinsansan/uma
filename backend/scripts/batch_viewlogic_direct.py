#!/usr/bin/env python3
"""
2024年G1全21レースのViewLogic展開予想結果を直接取得
ViewLogicエンジンを直接使用するバッチ処理
"""
...
def get_viewlogic_result(race_data: Dict) -> Optional[Dict]:
    """ViewLogic展開予想を取得"""
...
def main():
    """メイン処理"""
    print("=" * 70)
    print("2024年G1全21レース ViewLogic展開予想取得（直接実行）")
    print("=" * 70)
    ...
    for i, race in enumerate(G1_RACES_2024, 1):
        ...
        # ViewLogic結果取得
        result = get_viewlogic_result(race)
    ...
    # 結果をJSONファイルに保存
    output_file = "viewlogic_g1_results_2024_direct.json"
